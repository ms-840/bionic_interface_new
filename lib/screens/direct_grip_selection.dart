...
class _GripSelectorState extends State<GripSelector>{
  ...
  Widget build(BuildContext context) {
    ...
    var bleHandler = context.watch<BleInterface>();
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
      ...
      body: Padding(
        ...
        child: GridView.count(
          ...
          crossAxisSpacing: 10,
          mainAxisSpacing: 10,
          crossAxisCount: 2, //TODO: THIS SHOULD AUTOMATICALLY FILL THE SPACE IT HAS, ie if there is more horizontal space, turn to 3 or 4
          children: <Widget>[
